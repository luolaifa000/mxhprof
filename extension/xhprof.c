...
//zend_xhprof_globals xhprof_globals;
...
/**
 * 
 * static const zend_internal_arg_info arginfo_xhprof_enable[] = { 
        { (const char*)(zend_uintptr_t)(0), 0, 0, 0 },
		{ "flags", 0, 0, 0},
        { "options", 0, 0, 0},
    };
    {
        {name = 0x0, type = 0, pass_by_reference = 0 '\000', is_variadic = 0 '\000'}, 
        {name = 0x7fffeaad2fa8 "flags", type = 0, pass_by_reference = 0 '\000', is_variadic = 0 '\000'}, 
        {name = 0x7fffeaad2fae "options", type = 0, pass_by_reference = 0 '\000', is_variadic = 0 '\000'}
    }
 */
...
/**
 * 
 * static const zend_internal_arg_info arginfo_xhprof_disable[] = { 
		{ (const char*)(zend_uintptr_t)(-1), 0, 0, 0 },
    };
    {
        {name = 0xffffffffffffffff <Address 0xffffffffffffffff out of bounds>, type = 0, pass_by_reference = 0 '\000', is_variadic = 0 '\000'}
    }
 */
...
/**
 * 
 * static const zend_internal_arg_info arginfo_xhprof_sample_enable[] = { 
		{ (const char*)(zend_uintptr_t)(-1), 0, 0, 0 },
    };
    {
        {name = 0xffffffffffffffff <Address 0xffffffffffffffff out of bounds>, type = 0, pass_by_reference = 0 '\000', is_variadic = 0 '\000'}
...
/**
 * 
 * static const zend_internal_arg_info arginfo_xhprof_sample_disable[] = { 
		{ (const char*)(zend_uintptr_t)(-1), 0, 0, 0 },
    };
    {
        {name = 0xffffffffffffffff <Address 0xffffffffffffffff out of bounds>, type = 0, pass_by_reference = 0 '\000', is_variadic = 0 '\000'}
 ...
 * zend_function_entry xhprof_functions[] = {
   ...
   zend_function_entry xhprof_functions[] = {
        { 'xhprof_enable', zif_xhprof_enable, arginfo_xhprof_enable, 2, 0 },
        { 'xhprof_disable', zif_xhprof_disable, arginfo_xhprof_disable, 0, 0 },
        { 'xhprof_sample_enable', zif_xhprof_sample_enable, arginfo_xhprof_sample_enable, 0, 0 },
        { 'xhprof_sample_disable', zif_xhprof_sample_disable, arginfo_xhprof_sample_disable, 0, 0 },
        {NULL, NULL, NULL}
   };
   {
       {fname = 0x7fffeaad2f60 "xhprof_enable", handler = 0x7fffeaad2b60 <zif_xhprof_enable>, 
        arg_info = 0x7fffeacd4ba0 <arginfo_xhprof_enable>, num_args = 2, flags = 0}, {
        fname = 0x7fffeaad2f6e "xhprof_disable", handler = 0x7fffeaad0b10 <zif_xhprof_disable>, 
        arg_info = 0x7fffeaad3020 <arginfo_xhprof_disable>, num_args = 0, flags = 0}, {
        fname = 0x7fffeaad2f7d "xhprof_sample_enable", handler = 0x7fffeaad2d60 <zif_xhprof_sample_enable>, 
        arg_info = 0x7fffeaad3000 <arginfo_xhprof_sample_enable>, num_args = 0, flags = 0}, {
        fname = 0x7fffeaad2f92 "xhprof_sample_disable", handler = 0x7fffeaad0b80 <zif_xhprof_sample_disable>, 
        arg_info = 0x7fffeaad2fe0 <arginfo_xhprof_sample_disable>, num_args = 0, flags = 0}, 
        {fname = 0x0, handler = 0x0, arg_info = 0x0, num_args = 0, flags = 0}
    }
 */
zend_function_entry xhprof_functions[] = {
...
/**
  zend_module_entry xhprof_module_entry = {
        ...
        zm_shutdown_xhprof,          
        zm_activate_xhprof,
        zm_deactivate_xhprof,
        zm_info_xhprof,         
        "2.1.0",
        0, NULL, NULL, NULL, 0,0, 0, NULL, 0, ZEND_MODULE_BUILD_ID
...
static const zend_ini_entry_def ini_entries[] = {
    { "xhprof.output_dir", NULL, NULL, NULL, NULL, '', NULL, 7, sizeof("xhprof.output_dir")-1, sizeof("")-1 },
    { "xhprof.collect_additional_info", NULL, NULL, NULL, NULL, '0', NULL, 7, sizeof("xhprof.collect_additional_info")-1, sizeof('0')-1 },
    { "xhprof.sampling_interval", OnUpdateLong, (void *) XtOffsetOf(zend_xhprof_globals, sampling_interval), (void *) &xhprof_globals, NULL, 100000, NULL, PHP_INI_ALL, sizeof("xhprof.sampling_interval")-1, sizeof("100000")-1 },
    { "xhprof.sampling_depth", OnUpdateLong, (void *) XtOffsetOf(zend_xhprof_globals, sampling_depth), (void *) &xhprof_globals, NULL, 100000, NULL, PHP_INI_ALL, sizeof("xhprof.sampling_depth")-1, sizeof("100000")-1 },
    { NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0} 
}

{
    {name = 0x7fffeaad2ef6 "xhprof.output_dir", on_modify = 0x0, mh_arg1 = 0x0, mh_arg2 = 0x0, mh_arg3 = 0x0, 
    value = 0x7fffeaad2edf "", displayer = 0x0, modifiable = 7, name_length = 17, value_length = 0}, {
    name = 0x7fffeaad2fb8 "xhprof.collect_additional_info", on_modify = 0x0, mh_arg1 = 0x0, mh_arg2 = 0x0, mh_arg3 = 0x0, 
    value = 0x7fffeaad2ddb "0", displayer = 0x0, modifiable = 7, name_length = 30, value_length = 1}, {
    name = 0x7fffeaad2f08 "xhprof.sampling_interval", on_modify = 0xb929fc <OnUpdateLong>, mh_arg1 = 0x68, 
    mh_arg2 = 0x7fffeacd53e0 <xhprof_globals>, mh_arg3 = 0x0, value = 0x7fffeaad2f21 "100000", displayer = 0x0, 
    modifiable = 7, name_length = 24, value_length = 6}, 
    {name = 0x7fffeaad2f28 "xhprof.sampling_depth", on_modify = 0xb929fc <OnUpdateLong>, mh_arg1 = 0x78, mh_arg2 = 0x7fffeacd53e0 <xhprof_globals>, mh_arg3 = 0x0, 
    value = 0x7fffeaad2f3e "2147483647", displayer = 0x0, modifiable = 7, name_length = 21, value_length = 10}, {
    name = 0x0, on_modify = 0x0, mh_arg1 = 0x0, mh_arg2 = 0x0, mh_arg3 = 0x0, value = 0x0, displayer = 0x0, 
    modifiable = 0, name_length = 0, value_length = 0}}
 */
...
static void php_xhprof_init_globals(zend_xhprof_globals *xhprof_globals)
{
    ...
    xhprof_globals->laravel_namespace_prefix = NULL;
...
void hp_get_ignored_functions_from_arg(zval *args)
{
    ...
    zval *lzval;
    lzval = hp_zval_at_key("laravel_namespace_prefix", args);
    XHPROF_G(laravel_namespace_prefix) = hp_strings_in_zval(lzval);
}
...
void hp_laravel_functions_clear(char **functions)
{
    if (functions == NULL) {
        return;
    }
...
void hp_clean_profiler_state()
{
    ...
    hp_laravel_functions_clear(XHPROF_G(laravel_namespace_prefix));
    XHPROF_G(laravel_namespace_prefix) = NULL;
...
static int hp_filter_laravel_namespace_prefix(const char *function_name)
{
    char *src;
    char *des;
    int len, i = 0;
    ...
    char **name = XHPROF_G(laravel_namespace_prefix);
    if (!name) {
        return 0;
    }
...
ZEND_DLEXPORT void hp_execute_ex (zend_execute_data *execute_data)
{
    ...
    if (hp_filter_laravel_namespace_prefix(func)) {
        _zend_execute_ex(execute_data);
        return;
    }
